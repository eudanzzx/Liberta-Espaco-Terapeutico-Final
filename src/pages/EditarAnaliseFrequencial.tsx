...
const EditarAnaliseFrequencial = () => {
  ...
  useEffect(() => {
    ...
    if (analise) {
      ...
      setAtencao(analise.atencaoFlag || false);
  ...
  const handleSalvarAnalise = () => {
    ...
    // Encontrar índice da análise a ser atualizada
    const analiseIndex = analises.findIndex(a => a.id === id);
    ...
    // Atualizar análise no array
    analises[analiseIndex] = analiseAtualizada;
    ...
    <div className="min-h-screen bg-gray-50 py-6 px-4">
      <div className="container mx-auto max-w-4xl">
        ...
        <Card className="border-[#C5A3E0] shadow-sm mb-6">
          <CardHeader>
            <CardTitle className="text-[#2196F3]">Editar Análise</CardTitle>
          </CardHeader>
          <CardContent>
